...
public partial class BrigadaCareersDbv3Context : DbContext
{
    public BrigadaCareersDbv3Context()
    {
    }

    public BrigadaCareersDbv3Context(DbContextOptions<BrigadaCareersDbv3Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<TblUserRequirement> TblUserRequirements { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblCertificate>(entity =>
        {
            ...
            entity.HasOne(d => d.AppBinary).WithMany(p => p.TblCertificates)
                .HasForeignKey(d => d.AppBinaryId)
                .HasConstraintName("FK_Tbl_Certificate_Tbl_Appbinary");
        ...
        {
            entity.ToTable("Tbl_UserRequirements");
